    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([employee_id] = @Original_employee_id) AND (" +
                "[name] = @Original_name) AND ([position] = @Original_position) AND ([hourly_pay_" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([employee_id], [name], [position], [hourly_pay_rate" +
                "]) VALUES (@employee_id, @name, @position, @hourly_pay_rate);\r\nSELECT employee_i" +
                "d, name, position, hourly_pay_rate FROM Employee WHERE (employee_id = @employee_" +
                "id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [employee_id] = @employee_id, [name] = @name, [position] = @position, [hourly_pay_rate] = @hourly_pay_rate WHERE (([employee_id] = @Original_employee_id) AND ([name] = @Original_name) AND ([position] = @Original_position) AND ([hourly_pay_rate] = @Original_hourly_pay_rate));
SELECT employee_id, name, position, hourly_pay_rate FROM Employee WHERE (employee_id = @employee_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT employee_id, name, position, hourly_pay_rate FROM dbo.Employee";
