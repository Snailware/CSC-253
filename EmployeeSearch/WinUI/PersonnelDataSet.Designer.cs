...
namespace WinUI {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int id, string name, string position, decimal pay_rate) {
...
SELECT id, name, position, pay_rate FROM Employee WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT id, name, position, pay_rate \r\nFROM dbo.Employee\r\nWHERE name LIKE \'%\' + @n" +
                "ame + \'%\'";
        ...
        public virtual int SearchName(PersonnelDataSet.EmployeeDataTable dataTable, string name) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_position, decimal Original_pay_rate) {
        ...
        public virtual int Insert(int id, string name, string position, decimal pay_rate) {
        ...
        public virtual int Update(int id, string name, string position, decimal pay_rate, int Original_id, string Original_name, string Original_position, decimal Original_pay_rate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string position, decimal pay_rate, int Original_id, string Original_name, string Original_position, decimal Original_pay_rate) {
